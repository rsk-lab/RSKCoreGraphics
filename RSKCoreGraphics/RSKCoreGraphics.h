...
//! Project version number for RSKCoreGraphics.
FOUNDATION_EXPORT double RSKCoreGraphicsVersionNumber;

//! Project version string for RSKCoreGraphics.
FOUNDATION_EXPORT const unsigned char RSKCoreGraphicsVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <RSKCoreGraphics/PublicHeader.h>
